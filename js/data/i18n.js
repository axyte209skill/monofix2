...
export const STRINGS = {
  en: {
    ...
    wildColorPrompt: "Wild Property — choose which colour to play it as:",
    disconnectedReconnecting: "Connection lost — reconnecting…",
    connectionFailed: "Could not connect to the game server. Check your connection and refresh.",
  ...
  hi: {
    ...
    wildColorPrompt: "वाइल्ड प्रॉपर्टी — किस रंग के रूप में खेलनी है चुनें:",
    disconnectedReconnecting: "कनेक्शन टूट गया — दोबारा जोड़ रहे हैं…",
    connectionFailed: "गेम सर्वर से कनेक्ट नहीं हो सका। अपना कनेक्शन जांचें और रीफ्रेश करें।",
